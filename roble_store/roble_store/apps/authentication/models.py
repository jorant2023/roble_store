...
class Clientes(models.Model):
    ...
    nombres = models.CharField(max_length=150, blank=False, null=True)
    telefonouno = models.CharField(db_column='telefonoUno', max_length=15, blank=False, null=True)  # Field name made lowercase.
    ...
    email = models.CharField(db_column='email', blank=False, max_length=150)
